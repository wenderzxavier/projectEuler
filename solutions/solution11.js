const solution11 = () => {
    ...
    const getGridPosition = (rowIndex, columnIndex) => {
        return gridValues[rowIndex][columnIndex]
    }
    ...
    for( let rowIndex = 3; rowIndex < gridValues[0].length-3; rowIndex++){
        for( let columnIndex = 3; columnIndex < gridValues[0].length-3; columnIndex++ ){

            let actualValue = getGridPosition(rowIndex, columnIndex);

            let rightValue = 
                actualValue * 
                getGridPosition(rowIndex, columnIndex+1) * 
                getGridPosition(rowIndex, columnIndex+2) * 
                getGridPosition(rowIndex, columnIndex+3);

            let downValue = 
                actualValue *
                getGridPosition(rowIndex+1, columnIndex) *
                getGridPosition(rowIndex+2, columnIndex) *
                getGridPosition(rowIndex+3, columnIndex);

            let diagonalUp = 
                actualValue * 
                getGridPosition(rowIndex+1, columnIndex-1) *
                getGridPosition(rowIndex+2, columnIndex-2) *
                getGridPosition(rowIndex+3, columnIndex-3);
            ...
            if(downValue > biggestValue) {
                biggestValue = downValue
            }
            ...
            if(diagonalUp > biggestValue) {
                biggestValue = diagonalUp
            }

            if(diagonalDown > biggestValue) {
                biggestValue = diagonalDown
            }
        }
    }
